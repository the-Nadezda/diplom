...
<head>
    ...
    <title>Редактирование заказа клиента</title>
</head>
    ...
    <main>
        <div class="container">
            ...
            <div class="main-promotion_title_nav">
                <nav>
                    <ol>
                        ...
                        <li class="main-promotion_title_nav_link ml-30px">Редактирование карточки заказа клиента</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="main-popular_travel padding-50px">
                ...
                ?>
                        <form enctype="multipart/form-data" id="edit-form" action="include/edit_orders.php"
                            method="post">
                            <div>
                            ...
                            <div>
                                <label class="paument-label"
                                    ...
                                    for="edit-status">Изменить статус заказа:</label>
                                <input class="form_input" type="text" id="edit-status" name="edit-status"
                                    value="<?= $resArticle['status_id'] ?>" />
                            </div>
